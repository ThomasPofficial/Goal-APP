...
I would not hesitate to bring Thomas back for a future project, and I would not hesitate to tell any organization he applies to that he is the real thing.`,
  ...
  return NextResponse.json({
    ...
    accounts: {
      ...
      scholars: [
        { email: "thomas@piacentine.dev", password: "demo2026", note: "Thomas Piacentine — grade 12, Palo Alto HS, team lead — Studio 18 (Sunset Pines), archetypes: shark + lion" },
        { email: "diego.ramirez@nivarro.demo", password: "demo2026", note: "Diego Ramirez — grade 11, prototyper — Studio 18 (Sunset Pines), archetypes: cheetah + wolf" },
        { email: "aiko.tanaka@nivarro.demo", password: "demo2026", note: "Aiko Tanaka — grade 12, UX/accessibility — Studio 18 (Sunset Pines), archetypes: owl + tiger" },
        { email: "jordan.hayes@nivarro.demo", password: "demo2026", note: "Jordan Hayes — grade 11, systems/networking — Studio 18 (Sunset Pines), archetypes: gorilla + cheetah" },
        { email: "student@nivarro.demo", password: "demo2026", note: "Blank student account — no profile yet" },
        { email: "priya@nivarro.io", password: "demo2026", note: "Priya Nair — grade 11, data researcher, has org review" },
        { email: "marcus@nivarro.io", password: "demo2026", note: "Marcus Webb — grade 12, entrepreneur, has org review" },
        { email: "zoe@nivarro.io", password: "demo2026", note: "Zoe Kim — grade 11, full-stack developer, has org review" },
        { email: "elena@nivarro.demo", password: "demo2026", note: "Elena Vasquez — grade 12, policy researcher, Ridgepoint review" },
        { email: "james@nivarro.demo", password: "demo2026", note: "James Okafor — grade 11, economist, Ridgepoint review" },
        { email: "amara@nivarro.demo", password: "demo2026", note: "Amara Singh — grade 12, civic advocate, Ridgepoint review" },
        { email: "noah@nivarro.demo", password: "demo2026", note: "Noah Chen — grade 11, legal researcher, no review" },
        { email: "maya@nivarro.demo", password: "demo2026", note: "Maya Thompson — grade 12, policy writer, no review" },
      ],
    },
  });
  } catch (e: unknown) {
