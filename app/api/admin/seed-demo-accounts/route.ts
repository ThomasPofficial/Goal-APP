...
I would not hesitate to bring Thomas back for a future project, and I would not hesitate to tell any organization he applies to that he is the real thing.`,
  ...
  return NextResponse.json({
    ...
    accounts: {
      ...
      scholars: [
        { email: "thomas@piacentine.dev", password: "demo2026", note: "Thomas Piacentine — grade 12, Palo Alto HS, team lead — Studio 18 (Sunset Pines)" },
        { email: "diego.ramirez@nivarro.demo", password: "demo2026", note: "Diego Ramirez — grade 11, prototyper — Studio 18 (Sunset Pines)" },
        { email: "aiko.tanaka@nivarro.demo", password: "demo2026", note: "Aiko Tanaka — grade 12, UX/accessibility — Studio 18 (Sunset Pines)" },
        { email: "jordan.hayes@nivarro.demo", password: "demo2026", note: "Jordan Hayes — grade 11, systems/networking — Studio 18 (Sunset Pines)" },
