    ...
    <div className="max-w-4xl space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="space-y-2">
            {loading ? (
              ...
              scholars.map((scholar) => (
                <div key={scholar.id} className="bg-[#0D1525] border border-[rgba(201,168,76,0.12)] rounded-xl p-3 flex items-center gap-3 flex-wrap sm:flex-nowrap">
                      ...
                      <div className="space-y-1 w-48">
                        ...
                        <div className="flex gap-1">
                          <button
                            ...
                            className="flex-1 text-xs py-1 rounded-lg border border-[rgba(201,168,76,0.12)] text-[#8A8898]"
                          >
                            Cancel
                          </button>
                          <button
        ...
        <div className="space-y-4">
          ...
          <div className="bg-[#0D1525] border border-[rgba(201,168,76,0.12)] rounded-xl p-4 space-y-3 sticky top-6">
            {applied ? (
